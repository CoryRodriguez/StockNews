...
<objective>
Run the complete automated verification suite for Phase 3 and present a human verification checkpoint. All 13 requirements (EXEC-01 through EXEC-07, EXIT-01 through EXIT-06) must have automated evidence before the human checkpoint.
